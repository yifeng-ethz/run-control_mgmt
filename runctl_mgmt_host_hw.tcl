...
# Host Mu3e IP Core (SystemVerilog rewrite, version 26.3.2).
#
...
set VERSION_PATCH_DEFAULT_CONST 2         ;# bug-fix revision
set BUILD_DEFAULT_CONST         0513      ;# MMDD packaging date (May 13)
set VERSION_DATE_DEFAULT_CONST  20260513  ;# YYYYMMDD
set VERSION_GIT_DEFAULT_CONST   0x414E5CB ;# `git rev-parse --short HEAD`
