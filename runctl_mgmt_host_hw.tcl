...
# Host Mu3e IP Core (SystemVerilog rewrite, version 26.3.1).
#
...
set VERSION_PATCH_DEFAULT_CONST 1         ;# bug-fix revision
set BUILD_DEFAULT_CONST         0513      ;# MMDD packaging date (May 13)
set VERSION_DATE_DEFAULT_CONST  20260513  ;# YYYYMMDD
set VERSION_GIT_DEFAULT_CONST   0x329F94D ;# `git rev-parse --short HEAD`
